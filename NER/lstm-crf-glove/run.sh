n=112;#the variable that I want to be incremented
next_n=$[$n+1]
...
python3 extract-features0.py ../../../data/Train/MedLine > results/$n/train.cod
...
python3 extract-features0.py ../../../data/Test-NER/MedLine > results/$n/test.cod
