...
def get_sentences(fi):
    ...
    for line in fi:
        ...
        # Split the line with TAB characters.
        fields = line.split('\t')
        yield fields[5], fields[4], fields[6:]
...
if __name__ == '__main__':
    ...
    for xseq, yseq, feature in get_sentences(fi):
    ...
    for train_index, test_index in kf.split(X, Y):
        ...
        model.fit(train_x, train_y, validation_data=(val_x, val_y), verbose=1, epochs=5)
    ...
    for xseq,toks in instances_pred(open(sys.argv[2])):
        ...
        for k in range(0,len(toks)) :
            ...
            if y == "null":
                ...
                int = "1"
            out.write(sid + "|" + id_e1 + "|" + id_e2 + "|" + int + "|" + y + "\n")
