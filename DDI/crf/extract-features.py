...
def extract_features(tokens,entities,e1,e2) :
    ...
    isBefore = True
    isAfter = False
    tokenFeatures.append("e1=" + e1)
    tokenFeatures.append("e2=" + e2)
    ...
    tokenFeatures.append("TokensBefore=" + str(len(before)))
    tokenFeatures.append("TokensAfter=" + str(len(after)))
    tokenFeatures.append("TokensInBetween=" + str(len(inBetween)))
    ...
    for ele in searchList:
        ...
        for t in ele[1]:
            ...
            if t[3] in interest_pos:
                ...
                tokenFeatures.append(ele[0] + str(i) + "InterestLemmaPos=" + t[5])
...
for f in listdir(datadir) :
    ...
    for s in sentences :
        ...
        for p in pairs:
           ...
           features.append("amountOfPairs=" + str(len(pairs)))
